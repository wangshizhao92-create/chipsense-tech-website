...
const content = String.raw`import Image from "next/image";
        ...
        <div className="relative mx-auto flex min-h-[560px] max-w-7xl items-center px-6 py-20">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-3xl text-lg font-semibold leading-8 text-slate-100 md:text-xl">
              面向材料、器件、封装、MEMS 与传感器模组研发的计算仿真和软件平台服务
            </p>

            <p className="mt-5 max-w-3xl text-base leading-8 text-slate-300 md:text-lg">
              支持 Abaqus、Ansys、COMSOL、LAMMPS 等计算工具，提供有限元仿真、多物理场建模、分子动力学模拟、计算资源配置、仿真流程自动化和 MEMS 可靠性软件开发服务。
            </p>
...
console.log("包含新标题：", updated.includes("科研计算、仿真分析与工程软件服务"));
console.log("包含 MEMS：", updated.includes("MEMS 可靠性软件开发"));
console.log("仍含旧标题：", updated.includes("信息技术与计算服务"));